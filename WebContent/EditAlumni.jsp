...
<section id="content" class="column-center">
	...
	<br>
<%String s=null; %>
<form action= "EditAlumni?name=<%=request.getParameter("name")%>" method= "post">
Name:<input type="text" name="alname"/><br/><br/>
Members:<input type="text" name="member"/><br/><br/>
Founded:<input type="year" name="year"/><br/><br/>
